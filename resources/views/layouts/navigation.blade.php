<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 bg-constelation">
...
{{--                    </a>--}}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('Planetarium')" :active="request()->routeIs('Planetarium')">
                        {{ __('Planetarium') }}
                    </x-nav-link>
